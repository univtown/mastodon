...
class ChuckyaMigrateDefaultSkinSetting < ActiveRecord::Migration[8.0]
  ...
  def up
    ...
    return unless %w(modern-light modern-contrast system-modern modern-dark).include?(theme)

    setting.update_column('value', "--- modern\n")
  end
