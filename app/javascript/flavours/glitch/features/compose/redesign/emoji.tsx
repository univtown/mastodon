...
import { emojiUse } from '@/flavours/glitch/actions/emojis';
...
const EmojiPicker = lazy(() =>
  import('@/flavours/glitch/features/emoji/emoji_picker').then(
    ({ Picker }) => ({
      default: Picker,
    }),
  ),
...
const Emoji = lazy(() =>
  import('@/flavours/glitch/features/emoji/emoji_picker').then(({ Emoji }) => ({
    default: Emoji,
  })),
);
